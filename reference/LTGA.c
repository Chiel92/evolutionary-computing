...
char *installedProblemName( int index )
{
    ...
    case  0:
        return ( (char *) "Onemax" );
    case  1:
        return ( (char *) "Deceptive Trap 4 - Tight Encoding" );
    case  2:
        return ( (char *) "Deceptive Trap 4 - Loose Encoding" );
    case  3:
        return ( (char *) "Deceptive Trap 5 - Tight Encoding" );
    case  4:
        return ( (char *) "Deceptive Trap 5 - Loose Encoding" );
    }
...
void installedProblemEvaluation( int index, char *parameters, double *objective_value, double *constraint_value )
{
    ...
    *constraint_value = 0.0;
    ...
    {
    case  0:
        onemaxFunctionProblemEvaluation( parameters, objective_value, constraint_value );
        break;
    case  1:
        deceptiveTrap4TightEncodingFunctionProblemEvaluation( parameters, objective_value, constraint_value );
        break;
    case  2:
        deceptiveTrap4LooseEncodingFunctionProblemEvaluation( parameters, objective_value, constraint_value );
        break;
    case  3:
        deceptiveTrap5TightEncodingFunctionProblemEvaluation( parameters, objective_value, constraint_value );
        break;
    case  4:
        deceptiveTrap5LooseEncodingFunctionProblemEvaluation( parameters, objective_value, constraint_value );
        break;
    }
